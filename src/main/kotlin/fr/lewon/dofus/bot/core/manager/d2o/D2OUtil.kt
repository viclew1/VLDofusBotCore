package fr.lewon.dofus.bot.core.manager.d2o
...
object D2OUtil {
    ...
    fun getClassDefinition(moduleName: String, classId: Int): GameDataClassDefinition {
        val classes = classesByModuleName[moduleName] ?: error("no classes for module name : $moduleName")
    ...
    private fun initFromStream(stream: ByteArrayReader, moduleName: String) {
        ...
        for (i in 0 until classesCount) {
            this.readClassDefinition(stream.readInt(), stream, classes)
        }
    }
